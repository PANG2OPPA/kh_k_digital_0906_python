...
def search_student() :
    ...
    student_info = student_map.get(student_id) # get(key) 메소드로 학번을 얻어 옴
    if student_info :
...
def modify_student() :
    ...
    else : print("해당 학번의 학생정보를 찾을 수 없습니다.")
...
while True :
    ...
    choice = input("[1] 등록 [2] 검색 [3] 수정 [4] 삭제 [5] 전체보기 [6] 저장 [8]불러오기 [8] 종료 : ")
