...
# name_card("안유진", "서울시 강남구 삼성동", "010-1234-8509")
# name_card("장원영", "서울시 강남구 압구정동", "010-4321-8765")
...
# 매개변수에 기본값이 정의되어 있는 경우 함수 호출 시 인자값을 넣지 않으면 기본값을 호출 됨
...
# 가변 매개변수 : 변수의 개수가 정해지지 않은 경우에 사용 *(별표)
